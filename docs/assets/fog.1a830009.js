...
`}}const m={class:"container"},v={__name:"fog",setup(a){const{viewer:t}=window,e=new _(t,{visibility:.2,color:new Cesium.Color(.8,.8,.8,.3)}),l=()=>{e.show(!1)},c=()=>{e.show(!0)};return u(()=>{e.destroy()}),(p,o)=>{const i=h;return d(),g("div",m,[r(i,{type:"primary",onClick:c},{default:s(()=>o[0]||(o[0]=[n("\u5F00\u59CB")])),_:1}),r(i,{type:"primary",onClick:l},{default:s(()=>o[1]||(o[1]=[n("\u505C\u6B62")])),_:1})])}}},b=f(v,[["__scopeId","data-v-0abcb08b"]]);export{b as default};
